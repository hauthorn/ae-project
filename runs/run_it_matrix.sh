...
./matrixMultiply -a simpleTranspose -n 20 -max 1800 -m l1_dcm -f $1
./matrixMultiply -a simpleTranspose -n 20 -max 1800 -m l2_dcm -f $1
...
#
#
#./matrixMultiply -a 1d -n 20 -max 1800 -m br_msp -f $1
#./matrixMultiply -a 1d -n 20 -max 1800 -m br_cn -f $1
./matrixMultiply -a 1d -n 20 -max 1800 -m l1_dcm -f $1
./matrixMultiply -a 1d -n 20 -max 1800 -m l2_dcm -f $1


#./matrixMultiply -a 1dTranspose -n 20 -max 1800 -m br_msp -f $1
#./matrixMultiply -a 1dTranspose -n 20 -max 1800 -m br_cn -f $1
./matrixMultiply -a 1dTranspose -n 20 -max 1800 -m l1_dcm -f $1
./matrixMultiply -a 1dTranspose -n 20 -max 1800 -m l2_dcm -f $1