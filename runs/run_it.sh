...
./ae_project -a binaryTree -n 10000 -max 250000000 -m br_msp -f $1;
./ae_project -a binaryTree -n 10000 -max 250000000 -m br_cn -f $1;
./ae_project -a binaryTree -n 10000 -max 250000000 -m l1_dcm -f $1;
./ae_project -a binaryTree -n 10000 -max 250000000 -m l2_dcm -f $1;